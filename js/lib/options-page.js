var OptionsPage = (function () {
    ...
    */
    ...
    OptionsPage.NumericTypes = [
        'number', 
        'range'
    ];
    OptionsPage.CheckableTypes = [
        'checkbox', 
        'radio'
    ];
    OptionsPage.RadioTypes = [
        'radio'
    ];
    OptionsPage.MultiSelectTypes = [
        'select-multiple'
    ];
    OptionsPage.Transform = {
        Load: 'loadfunc',
        Save: 'savefunc'
    };
    ...
    */
    function getTransformFunction(element, funcName) {
    ...
    OptionsPage.prototype.addInput = /**
    ...
    */
        ...
        if(!this.initialized) {
            ...
            if(element.tagName && OptionsPage.isInput(element)) {
                ...
                if(resetButton !== undefined) {
                    this._addResetButton(resetButton, [
                        element
                    ]);
                } else {
    ...
    OptionsPage.prototype.debugStorage = /**
    ...
    */
    ...
    OptionsPage.prototype._onDOMContentLoaded = /* Private Functions */
    function () {
        var _this = this;
...
var ModalDialog = (function () {
    ...
    ModalDialog.confirm = function confirm(title, text, callback) {
    ...
    ModalDialog.message = function message(title, text, onclose) {
        if(typeof onclose !== 'function') {
            onclose = function (e) {
                return undefined;
            };
